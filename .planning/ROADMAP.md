...
- [x] 12-02-PLAN.md — predict.py: per-session `account_id`, `_UNSET` sentinel, R5b no-borrow keying locator, thread `account_uuid` through store consumers + landmines [Wave 2]
